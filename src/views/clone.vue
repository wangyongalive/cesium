    ...
    export default {
        ...
        methods: {
            ...
            clone(option) {
                ...
                // pitch 俯仰角
                // roll 滚转角
                let {label, scale, url, longitude, latitude, height, heading, pitch, roll, value} = option;
            ...
            initCesium() {
                ...
                let flashlight = new Cesium.DirectionalLight({
                    direction: self.viewer.scene.camera.directionWC, // Updated every frame
                });
                self.viewer.scene.preRender.addEventListener(function (scene, time) {
                ...
                self.viewer.scene.light = flashlight;
